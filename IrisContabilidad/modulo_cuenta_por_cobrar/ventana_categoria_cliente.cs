...
namespace IrisContabilidad.modulo_cuenta_por_cobrar
{
    public partial class ventana_categoria_cliente : formBase
    {
        ...
        public ventana_categoria_cliente()
        {
            ...
            this.tituloLabel.Text = utilidades.GetTituloVentana(empleado, "customer category/categoria cliente");
        ...
        public bool validarGetAction()
        {
            try
            {
                ...
                if (nombreText.Text == "")
                {
                    MessageBox.Show("The name of the category is missing/Falta el nombre de la categoria", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    nombreText.Focus();
                    nombreText.SelectAll();
                    return false;
                }
