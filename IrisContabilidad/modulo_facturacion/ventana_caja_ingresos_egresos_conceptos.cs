...
namespace IrisContabilidad.modulo_facturacion
{
    public partial class ventana_caja_ingresos_egresos_conceptos : formBase
    {
        ...
        public ventana_caja_ingresos_egresos_conceptos()
        {
            ...
            this.tituloLabel.Text = utilidades.GetTituloVentana(empleado, "concept of expenditures and income/conceptos de ingresos e ingresos");
        ...
        public bool validarGetAction()
        {
            try
            {
                ...
                if (nombreText.Text == "")
                {
                    MessageBox.Show("The name of the concept is missing/Falta el nombre del concepto", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    nombreText.Focus();
